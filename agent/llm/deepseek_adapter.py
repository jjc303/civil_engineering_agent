...
只允许选择 query_violations、get_violation_statistics、get_camera_status、get_all_camera_statuses、get_current_weather 五个工具之一。
...
查询单个设备运行情况时选择 get_camera_status 且必须给出 camera_id；查询所有/全部摄像头的状态或帧率时选择 get_all_camera_statuses，camera_id 必须为 null。
